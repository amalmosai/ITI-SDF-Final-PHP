<?php
    ...
    $stmt=$db->prepare($sql);
    $stmt->execute();
    $c_product=$stmt->fetch(pdo :: FETCH_ASSOC);
    // print_r($c_product);
    $count_product=$c_product['count(product_id)'];

    /////////sum sales 
    $sql= "select sum(price) from orders";
    $stmt=$db->prepare($sql);
    $stmt->execute();
    $s_price=$stmt->fetch(pdo :: FETCH_ASSOC);
    // print_r($c_price);
    $sum_price=$s_price['sum(price)'];
    
    //////////orders count
    $sql= "select count(order_id) from orders";
    $stmt=$db->prepare($sql);
    $stmt->execute();
    $c_order=$stmt->fetch(pdo :: FETCH_ASSOC);
    // print_r($c_product);
    $count_order=$c_order['count(order_id)'];
    ...
    // print_r($c_product);
    $count_item=$c_item['count(item_id)']; 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="../css/dashboard.css???8787" />
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="index.php?action=dashboard" class="list-group-item list-group-item-action bg-transparent second-text active">
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><img width='60px' src='../../assets/imgs/users_imgs/<?=$value['image']?>'></td>
