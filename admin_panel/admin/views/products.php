...
<head>
    ...
    <link rel="stylesheet" href="../css/dashboard.css?767" />
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="index.php?action=product" class="list-group-item list-group-item-action bg-transparent second-text active">
                ...
                <div class="row my-5 p-4">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead class="t_head">
                                <tr>
                                    <th scope="col" width="80">product_id</th>
                            ...
                            ?>     
                                <tr>
                                    ...
                                    <td><?=$value['price']?></td>
                                    <td><img width='60px' src="../../assets/imgs/products_imgs/<?php echo $value['image'] ;?>"></td>
                                    <td><?=$value['quantity']?></td>
                                    <td><?=$value['fullname']?></td>                                  
                                    <td><a href="./index.php?id=<?=$value['product_id']?>&action=product_del" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-duotone fa-trash me-2"></i></a></td> 
                                </tr>
                            <?php    
                            }
                            ?>        
