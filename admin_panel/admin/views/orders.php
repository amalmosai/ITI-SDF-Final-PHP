...
<head>
    ...
    <link rel="stylesheet" href="../css/dashboard.css?97" />
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="index.php?action=order" class="list-group-item list-group-item-action bg-transparent second-text active">
                ...
                <div class="row my-5 p-4">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead class="t_head">
                                <tr>
                                    <th scope="col" width="100">Oder_product</th>
                            ...
                            ?> 
                                <tr>
                                    ...
                                    <td><a href="./index.php?id=<?=$value['id']?>&action=order_del" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-duotone fa-trash me-2"></i></a></td> 
                                </tr>
                            <?php    
                            }
                            ?>
