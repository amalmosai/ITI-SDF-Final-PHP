                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead class="t_head">
                                <tr>
                                    ...
                                    <th scope="col"><i class="fas fa-solid fa-plus me-2"></i>Add</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="index.php?action=create" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-solid fa-plus me-2"></i></a></td>
                                    <td><a href="./index.php?id=<?=$value['user_id']?>&action=user_del" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-duotone fa-trash me-2"></i></a></td> 
                                </tr>
                                <?php    
                                }
                                ?>
